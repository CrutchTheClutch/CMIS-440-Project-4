...
public class DukeETFServlet extends HttpServlet {
    ...
    void send(String date, String time, String price, String volume, String high, String low) {
        /* Send update to all connected clients */
        for (AsyncContext acontext : requestQueue) {
            try {
                String msg = String.format("%s , %s , %s , %s , %s , %s", date, time, price, volume, high, low); // "%.2f / %d"
